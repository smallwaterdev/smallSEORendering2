...
contentsRoute.get('/:name', (req, res, next)=>{
    genContentListHtml('director', req.params.name, null, null, res);
});
contentsRoute.get('/:name/:sort', (req, res, next)=>{
    genContentListHtml('director', req.params.name, req.params.sort, null, res);
});
contentsRoute.get('/:name/:sort/:page', (req, res, next)=>{
    genContentListHtml('director', req.params.name, req.params.sort, req.params.page, res);
});
